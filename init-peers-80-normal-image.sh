...
echo "# * For Codec zero button button, use ptt_down_code_0 = 108 " >> $CREATE_PATH/pttkey.ini
echo "ptt_down_type_0 = 1 " >> $CREATE_PATH/pttkey.ini
echo "ptt_down_code_0 = 108 " >> $CREATE_PATH/pttkey.ini
echo "ptt_down_value_0 = 1" >> $CREATE_PATH/pttkey.ini
echo "ptt_up_type_0 = 1 " >> $CREATE_PATH/pttkey.ini
echo "ptt_up_code_0 = 108 " >> $CREATE_PATH/pttkey.ini
